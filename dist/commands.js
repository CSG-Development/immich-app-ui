...
import { screencastManager } from './services/screencast-manager.svelte.js';
import { themeManager } from './services/theme-manager.svelte.js';
import { Constants } from './site/constants.js';
import { ThemePreference } from './types.js';
import { isExternalLink, navigateTo, resolveUrl } from './utilities/common.js';
import { mdiKeyboard, mdiOpenInNew, mdiThemeLightDark } from '@mdi/js';
export const linkCommands = (items) => {
    return items.map(linkCommand);
};
export const linkCommand = (item) => ({
...
// for reactivity
export const getSettingCommands = () => [
    {
