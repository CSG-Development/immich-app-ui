...
export { default as GithubLink } from './components/GithubLink/GithubLink.svelte';
...
export { default as ScreencastOverlay } from './components/ScreencastOverlay/ScreencastOverlay.svelte';
...
export * from './services/screencast-manager.svelte.js';
export * from './services/theme-manager.svelte.js';
